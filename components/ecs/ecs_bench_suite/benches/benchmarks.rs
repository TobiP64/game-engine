...
fn bench_simple_insert(c: &mut Criterion) {
    ...
    //    b.iter(move || bench.run());
    //});
    group.bench_function("tecs", |b| {
        let mut bench = tecs::simple_insert::Benchmark::new();
        b.iter(move || bench.run());
    });
}
...
fn bench_simple_iter(c: &mut Criterion) {
    ...
    //});
    group.bench_function("tecs", |b| {
        let mut bench = tecs::simple_iter::Benchmark::new();
        b.iter(move || bench.run());
    });
}
...
fn bench_frag_iter_bc(c: &mut Criterion) {
    ...
    //});
    group.bench_function("tecs", |b| {
        let mut bench = tecs::frag_iter::Benchmark::new();
        b.iter(move || bench.run());
    });
}
...
fn bench_heavy_compute(c: &mut Criterion) {
    ...
    //});
    group.bench_function("tecs", |b| {
        let mut bench = tecs::heavy_compute::Benchmark::new();
        b.iter(move || bench.run());
    });
}
...
fn bench_add_remove(c: &mut Criterion) {
    ...
    //});
    group.bench_function("tecs", |b| {
        let mut bench = tecs::add_remove::Benchmark::new();
        b.iter(move || bench.run());
    });
}
